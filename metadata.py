...
BASE_IMAGE_URL = "https://gateway.pinata.cloud/ipfs/Qma157SytEgHPAWhH4izvy8u4RCwwyzqJUvGgW8pdNnXVH"
BASE_NAME = "Outlier #"

BASE_JSON = {
    "name": BASE_NAME,
    "description": "A community-driven project featuring art by Outlier0x1. Every Outlier grants you access to many rewards and privileges.\
 In addition to which each NFT gives exposure to 11 upcoming projects with never experimented before ideas blending art, utility & innovation.\
 The True Outliers.",
